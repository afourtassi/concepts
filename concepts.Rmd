...
Calculate proportion of explicit categorization utterances relative to all utterances in a given category
```{r}
...
for (age in 1:length(explicit_files)){
    ...
    kable(explicit_proportion, digits = 5)
}
```
...
for (age in 1:length(txt_files)){
  ...
  #Will probably need to add titles later
