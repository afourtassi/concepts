...
% (Chi et al., 1989; Carey, 1985; Inagaki
...
% (Blewitt, 1983; Shipley et al., 1983; Callanan, 1985).
For example,
...
% (Huebner and Willits, 2018; Fourtassi et al., 2019).
To
...
%
% To evaluate cue contributions jointly in the same classification setting, we fit logistic regressions predicting the binary classification of pairs of
