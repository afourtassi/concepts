...
Correspondence concerning this article should be addressed to Michael C. Frank, Postal address. E-mail: xx}
...
affordance of the superordinate category, i.e., \enquote{food}, \enquote{clothes},
\enquote{vehicles}, and \enquote{toys}. The accuracy was low in the case of the
\enquote{furniture} category since the verb \enquote{use} is not exclusive to this
...
\enquote{animal} category was low as it was not characterized
...
\subsubsection{The pure co-occurrence cue is the most reliable}\label{the-pure-co-occurrence-cue-is-the-most-reliable}}

The distributional semantic cue was the most implicit but also the most powerful. The AUC score for this method was generally high, including for the \enquote{animals} and \enquote{furniture}
...
\subsubsection{The cues are stable across development}\label{the-cues-are-stable-across-development}}
